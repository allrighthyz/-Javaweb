...
.navbar{
	height: 100px;
	margin: 0;
	background-image: linear-gradient( #cfa1c2 20%, #6f9bc4 70%);
}
.navbar ul{
	width: 100%;
	height: 100px;
		...
		<nav class="navbar">
			<ul class="nav navbar-nav " style="border-bottom:#517fa4 2px">
				...
				<li class="li-sty1" style="float:right;">
					<a href="ServletLogout" style="font-size: 24px;line-height: 17px;letter-spacing: 0.057em;font-weight: 500;color:#eba3c2c4;">退出</a>
				</li>
